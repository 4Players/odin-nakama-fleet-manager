...
// checks if the UpdateDockerRegistryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDockerRegistryRequest{}

// UpdateDockerRegistryRequest struct for UpdateDockerRegistryRequest
...
type _UpdateDockerRegistryRequest UpdateDockerRegistryRequest
...
func NewUpdateDockerRegistryRequest(type_ DockerRegistryType, name string) *UpdateDockerRegistryRequest {
	this := UpdateDockerRegistryRequest{}
	this.Type = type_
	this.Name = name
	return &this
}
...
func (o *UpdateDockerRegistryRequest) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o *UpdateDockerRegistryRequest) SetInstanceUrlNil() {
...
func (o *UpdateDockerRegistryRequest) SetUsernameNil() {
	o.Username.Set(nil)
}
...
func (o *UpdateDockerRegistryRequest) SetAccessTokenNil() {
...
func (o *UpdateDockerRegistryRequest) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *UpdateDockerRegistryRequest) SetAwsAccessKeyNil() {
...
func (o *UpdateDockerRegistryRequest) SetAwsSecretAccessKeyNil() {
...
func (o UpdateDockerRegistryRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateDockerRegistryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateDockerRegistryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateDockerRegistryRequest := _UpdateDockerRegistryRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateDockerRegistryRequest)

	if err != nil {
		return err
	}

	*o = UpdateDockerRegistryRequest(varUpdateDockerRegistryRequest)

	return err
}

type NullableUpdateDockerRegistryRequest struct {
	value *UpdateDockerRegistryRequest
	isSet bool
}

func (v NullableUpdateDockerRegistryRequest) Get() *UpdateDockerRegistryRequest {
	return v.value
}

func (v *NullableUpdateDockerRegistryRequest) Set(val *UpdateDockerRegistryRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDockerRegistryRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDockerRegistryRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDockerRegistryRequest(val *UpdateDockerRegistryRequest) *NullableUpdateDockerRegistryRequest {
	return &NullableUpdateDockerRegistryRequest{value: val, isSet: true}
}

func (v NullableUpdateDockerRegistryRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDockerRegistryRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
