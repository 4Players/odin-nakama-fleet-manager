...
[**UpdateBinary**](BinaryAPI.md#UpdateBinary) | **Put** /v1/binaries/{binary} | Update a binary and the related entity
...
func main() {
	...
	resp, r, err := apiClient.BinaryAPI.CreateBinary(context.Background(), app).StoreBinaryRequest(storeBinaryRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinaryAPI.CreateBinary``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CreateBinary`: Binary
	fmt.Fprintf(os.Stdout, "Response from `BinaryAPI.CreateBinary`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.BinaryAPI.DeleteBinary(context.Background(), binary).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinaryAPI.DeleteBinary``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.BinaryAPI.DeleteUnusedBinaries(context.Background(), app).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinaryAPI.DeleteUnusedBinaries``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.BinaryAPI.GetBinaries(context.Background(), app).PerPage(perPage).Page(page).Sort(sort).FilterName(filterName).FilterNamePartial(filterNamePartial).FilterVersion(filterVersion).FilterType(filterType).FilterOs(filterOs).FilterMaintenance(filterMaintenance).FilterStatus(filterStatus).FilterInUse(filterInUse).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinaryAPI.GetBinaries``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetBinaries`: GetBinaries200Response
	fmt.Fprintf(os.Stdout, "Response from `BinaryAPI.GetBinaries`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.BinaryAPI.GetBinaryById(context.Background(), binary).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinaryAPI.GetBinaryById``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetBinaryById`: Binary
	fmt.Fprintf(os.Stdout, "Response from `BinaryAPI.GetBinaryById`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.BinaryAPI.RefreshBinary(context.Background(), binary).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinaryAPI.RefreshBinary``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `RefreshBinary`: Binary
	fmt.Fprintf(os.Stdout, "Response from `BinaryAPI.RefreshBinary`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.BinaryAPI.StartServersForBinary(context.Background(), binary).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinaryAPI.StartServersForBinary``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.BinaryAPI.StopServersForBinary(context.Background(), binary).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinaryAPI.StopServersForBinary``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.BinaryAPI.UpdateBinary(context.Background(), binary).UpdateBinaryRequest(updateBinaryRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinaryAPI.UpdateBinary``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UpdateBinary`: Binary
	fmt.Fprintf(os.Stdout, "Response from `BinaryAPI.UpdateBinary`: %v\n", resp)
}
```
