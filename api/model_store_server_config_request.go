...
// checks if the StoreServerConfigRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoreServerConfigRequest{}

// StoreServerConfigRequest struct for StoreServerConfigRequest
type StoreServerConfigRequest struct {
...
type _StoreServerConfigRequest StoreServerConfigRequest
...
func (o *StoreServerConfigRequest) SetArgsNil() {
	o.Args.Set(nil)
}
...
func (o *StoreServerConfigRequest) SetCommandNil() {
	o.Command.Set(nil)
}
...
func (o *StoreServerConfigRequest) SetNotesNil() {
	o.Notes.Set(nil)
}
...
func (o StoreServerConfigRequest) MarshalJSON() ([]byte, error) {
...
func (o StoreServerConfigRequest) ToMap() (map[string]interface{}, error) {
...
func (o *StoreServerConfigRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varStoreServerConfigRequest := _StoreServerConfigRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStoreServerConfigRequest)

	if err != nil {
		return err
	}

	*o = StoreServerConfigRequest(varStoreServerConfigRequest)

	return err
}

type NullableStoreServerConfigRequest struct {
	value *StoreServerConfigRequest
	isSet bool
}

func (v NullableStoreServerConfigRequest) Get() *StoreServerConfigRequest {
	return v.value
}

func (v *NullableStoreServerConfigRequest) Set(val *StoreServerConfigRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableStoreServerConfigRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableStoreServerConfigRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoreServerConfigRequest(val *StoreServerConfigRequest) *NullableStoreServerConfigRequest {
	return &NullableStoreServerConfigRequest{value: val, isSet: true}
}

func (v NullableStoreServerConfigRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoreServerConfigRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
